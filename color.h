...
void lifx_lan_color_rgb(struct lifx_lan_color* color, uint8_t red, uint8_t green, uint8_t blue);
void lifx_lan_color_rgbk(struct lifx_lan_color* color, uint8_t red, uint8_t green, uint8_t blue, uint16_t kelvin);
